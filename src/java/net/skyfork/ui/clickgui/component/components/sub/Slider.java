...
import net.skyfork.value.impl.NumberValue;
...
public class Slider extends Component {
    ...
    public void renderComponent() {
        ...
        FontManager.S18.drawStringWithShadow(this.val.getName() + ": " + this.val.getValue(), (parent.parent.getX() + 8) , (parent.parent.getY() + offset + 2)  + 1, -1);
