...
import net.skyfork.event.impl.EventStoppable;
import net.skyfork.event.impl.Event;
import net.skyfork.event.types.Priority;
...
public final class EventManager {
     ...
     * a new MethodData to key's matching list and sorts it based on Priority. @see net.skyfork.event.types.Priority
     * Otherwise it will put a new entry in the HashMap with a first argument's class
     ...
     *
     * @see net.skyfork.event.EventTarget
     */
     ...
     * First gets the matching list from the registry map based on the class of the event.
    ...
    private static final class MethodData {
         ...
         * @param target
         *         The targeted Method to which the Event should be sent to.
         * @param priority
