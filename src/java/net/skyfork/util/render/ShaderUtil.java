...
import net.skyfork.util.misc.FileUtil;
...
public class ShaderUtil implements Wrapper {
    ...
    public ShaderUtil(String fragmentShadersrc, boolean notUsed) {
        ...
        int vertexShaderID;
        try {
            vertexShaderID = createShader(mc.getResourceManager().getResource(Client.getLocation("shaders/vertex.vsh")).getInputStream(), GL_VERTEX_SHADER);
        } catch (IOException e) {
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        this(fragmentShaderLoc, "skyfork/shaders/vertex.vsh");
    }
